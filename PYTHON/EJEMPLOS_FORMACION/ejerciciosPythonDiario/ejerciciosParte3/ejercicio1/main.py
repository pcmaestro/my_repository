...
100 puntos, entra en la segunda cueva y gana el tesoro, se le acreditan otros 100 puntos. 
Si el jugador pierde, saldrá en pantalla el total de los puntos que realizo y la opción 
de empezar de nuevo.
'''
#Reino del Dragon....
import random
...
def cheqcueva(CambiarCueva):
    ...
    if CambiarCueva == str(FriendlyCueva):
        ...
        print("Tienes acumulados " + str(puntos) + " puntos")
