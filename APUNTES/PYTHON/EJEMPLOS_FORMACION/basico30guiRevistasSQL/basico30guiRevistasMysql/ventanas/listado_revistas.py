...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(300, 50, 191, 21))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.listado_revistas = QtWidgets.QTextEdit(self.centralwidget)
        self.listado_revistas.setGeometry(QtCore.QRect(90, 100, 641, 441))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "listado de revistas:"))
