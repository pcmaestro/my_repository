...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(230, 50, 341, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.list_widget_revistas = QtWidgets.QListWidget(self.centralwidget)
        self.list_widget_revistas.setGeometry(QtCore.QRect(60, 110, 681, 431))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "LISTADO USANDO LIST WIDGET"))
